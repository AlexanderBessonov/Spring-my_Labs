...
public class OrderController {
   ...
   @GetMapping("/paymentMethod/{paymentMethod}")
    public ResponseEntity <ResponseWrapper> retrieveListListOrder(@PathVariable("paymentMethod")PaymentMethod paymentMethod){
    ...
    public ResponseEntity <ResponseWrapper> retrieveListListOrder(@PathVariable("email") String email){
