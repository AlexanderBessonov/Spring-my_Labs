...
public class ProductController {
    ...
    public ResponseEntity<ResponseWrapper> updateProduct(@RequestBody ProductDTO productDTO){
        ...
        return ResponseEntity
                .ok(new ResponseWrapper("Product are successfully update"
    ...
    public ResponseEntity<ResponseWrapper> retrieveProductByCategoryAndPrice(@RequestBody ProductRequest productRequest) {
        ...
        return ResponseEntity
                .ok(new ResponseWrapper("Product are successfully retrieve"
    ...
    public ResponseEntity<ResponseWrapper> retrieveProductByCategory(@PathVariable("id") Long categoryId){
