...
public class CustomerController {
    ...
    @PutMapping
    public ResponseEntity <ResponseWrapper>  updatelCustomer(@RequestBody CustomerDTO customerDTO){
    ...
    @GetMapping("/{email}")
    public ResponseEntity <ResponseWrapper>  getDiscountByEmail(@PathVariable("email") String email){
